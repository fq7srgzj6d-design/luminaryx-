...
// Imágenes locales (rutas según tu carpeta src/assets)
...
const LuminaryX = () => {
  ...
  const products = [
    ...
    {
      id: 5,
      title: 'Escudo Equipo / Trofeo',
      category: 'Anime & Gamer',
      price: '$590 MXN',
      image: trofeoEquipo,
      description:
        'Para campeones: escudos de equipos de fútbol, e-sports o trofeos personalizados.',
      glowColor: 'cyan',
    },
    {
      id: 6,
      ...
      description:
        'El regalo perfecto para dentistas, doctores y otros profesionales.',
      glowColor: 'pink',
    },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-purple-500/50 selection:text-white">
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
          <div className="absolute -top-10 -right-5 w-[500px] h-[500px] bg-purple-600/30 rounded-full blur-3xl animate-pulse-slow" />
          <div
            className="absolute bottom-[10%] -left-10 w-[500px] h-[500px] bg-cyan-600/30 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="mt-12 flex justify-center gap-4">
            ...
            >
              ...
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-xl" />
            </a>
            <a
              href="#proceso"
            ...
            >
              ...
              <div className="absolute inset-0 bg-cyan-400 opacity-0 group-hover:opacity-10 transition-opacity duration-300 blur-xl" />
            </a>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-slate-400 text-sm">
                Diseñamos a partir de tu foto o idea, no usamos plantillas
                genéricas.
              </p>
            </div>
            ...
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-slate-400 text-sm">
                Acrílico de alta resistencia y bases LED táctiles con cambio de
                color.
              </p>
            </div>
            ...
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-slate-400 text-sm">
                Empaque elegante y seguro. La mejor experiencia de unboxing.
              </p>
            </div>
          </div>
        </div>
          ...
          {filteredProducts.map((product) => (
            <div
              ...
              className={`group bg-slate-900 rounded-2xl overflow-hidden border border-slate-800 transition-all duration-500 relative hover:z-10
                ${
                  product.glowColor === 'purple'
                    ? 'hover:border-purple-500/50 hover:shadow-[0_0_40px_rgba(168,85,247,0.4)]'
                    : ''
                }
                ${
                  product.glowColor === 'cyan'
                    ? 'hover:border-cyan-500/50 hover:shadow-[0_0_40px_rgba(34,211,238,0.4)]'
                    : ''
                }
                ${
                  product.glowColor === 'green'
                    ? 'hover:border-green-500/50 hover:shadow-[0_0_40px_rgba(34,197,94,0.4)]'
                    : ''
                }
                ${
                ...
                ${
                  product.glowColor === 'pink'
                    ? 'hover:border-pink-500/50 hover:shadow-[0_0_40px_rgba(236,72,153,0.4)]'
                    : ''
                }`}
            >
              <div
              ...
              <div className="relative h-64 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/20 to-transparent opacity-80 z-10" />
                <img
                  src={product.image}
                  alt={product.title}
              ...
              <div className="p-6 relative z-20 bg-slate-900/80 backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 text-white px-4 py-2 rounded-lg font-medium transition-all text-sm shadow-lg border bg-purple-600 hover:bg-purple-500 border-purple-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]"
                  >
      ...
      <section
        id="proceso"
        className="py-20 bg-slate-900 border-y border-white/5 relative overflow-hidden"
      >
        <div className="absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-transparent via-purple-500/30 to-transparent -translate-y-1/2 blur-md pointer-events-none hidden md:block" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 drop-shadow-[0_0_5px_rgba(255,255,255,0.1)]">
              Convertimos tu idea en luz en 4 pasos.
            </p>
          </div>
            ...
            {[
              {
                step: '01',
                title: 'Tu idea',
                desc: 'Envíanos tu foto, logo o idea por WhatsApp.',
                icon: <Lightbulb size={24} />,
              },
              {
                step: '02',
                title: 'Diseño',
                desc: 'Creamos un boceto digital para que veas cómo quedará.',
                icon: <Briefcase size={24} />,
              },
              {
                step: '03',
                title: 'Fabricación',
                desc: 'Cortamos el acrílico y preparamos la base LED.',
                icon: <Sparkles size={24} />,
              },
              {
                step: '04',
                title: 'Entrega',
                desc: 'Empacamos y entregamos tu lámpara lista para brillar.',
                icon: <Gift size={24} />,
              },
            ].map((item, index) => (
      ...
      <footer
        id="contacto"
        className="bg-slate-950 pt-16 pb-8 border-t border-white/10 relative"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 lg:col-span-2">
              ...
              <p className="text-slate-400 mb-6 max-w-sm drop-shadow-[0_0_2px_rgba(255,255,255,0.1)]">
                Estudio de diseño dedicado a transformar recuerdos en objetos de
                luz. Con base en Puerto Vallarta, Jalisco.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="#home"
                    className="text-slate-400 hover:text-white hover:drop-shadow-[0_0_5px_rgba(255,255,255,0.8)] transition-all"
                  >
                    Inicio
                  </a>
                </li>
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">
              © {new Date().getFullYear()} LuminaryX. Todos los derechos
              reservados.
            </p>
