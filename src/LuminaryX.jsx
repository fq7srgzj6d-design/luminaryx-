...
// Imágenes locales (asegúrate de que existan en src/assets/)
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-slate-400 text-sm">
                No usamos plantillas genéricas. Diseñamos a partir de tu foto o idea.
              </p>
            </div>
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
              ...
              <p className="text-slate-400 text-sm">
                Acrílico de alta resistencia y bases LED táctiles con cambio de color.
              </p>
            </div>
            <div className="p-6 group hover:bg-slate-800/50 rounded-2xl transition-colors duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className={`flex items-center gap-2 text-white px-4 py-2 rounded-lg font-medium transition-all text-sm shadow-lg border
                      ${
                        product.glowColor === 'purple'
                          ? 'bg-purple-600 hover:bg-purple-500 border-purple-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]'
                          : ''
                      }
                      ${
                        product.glowColor === 'cyan'
                          ? 'bg-cyan-600 hover:bg-cyan-500 border-cyan-500 hover:shadow-[0_0_20px_rgba(34,211,238,0.6)]'
                          : ''
                      }
                      ${
                        product.glowColor === 'green'
                          ? 'bg-green-600 hover:bg-green-500 border-green-500 hover:shadow-[0_0_20px_rgba(34,197,94,0.6)]'
                          : ''
                      }
                      ${
                        product.glowColor === 'blue'
                          ? 'bg-blue-600 hover:bg-blue-500 border-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.6)]'
                          : ''
                      }
                      ${
                        product.glowColor === 'pink'
                          ? 'bg-pink-600 hover:bg-pink-500 border-pink-500 hover:shadow-[0_0_20px_rgba(236,72,153,0.6)]'
                          : ''
                      }
                    `}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: '03',
                title: 'Fabricación',
                desc: 'Una vez aprobado, cortamos el acrílico y preparamos la base.',
